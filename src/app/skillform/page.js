    ...
    <div className="min-h-screen bg-gray-50 flex justify-center items-center mt-10 px-4 py-12">
      ...
      >
        ...
        <div className="w-full h-2 bg-gray-200 rounded-full mb-8">
          <div
            className={`h-full rounded-full transition-all duration-500 ${step === 1 ? "w-1/3 bg-blue-600" : step === 2 ? "w-2/3 bg-blue-600" : "w-full bg-blue-600"
              }`}
          ></div>
        </div>
          ...
          <section className="space-y-6">
            ...
            <div className="flex justify-end pt-4">
              <button
                type="button"
                onClick={async () => {
                  const ok = await trigger(["role", "battingStyle", "bowlingStyle", "level"]);
                  if (ok) setStep(2);
                }}
        ...
        {step === 2 && (
          <section className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {errors.highestScore && (
                <p className="text-red-500 text-xs mt-1">{errors.highestScore.message}</p>
              )}
            ...
            <div className="flex justify-between pt-4">
              ...
              <button
                type="button"
                onClick={async () => {
                  const ok = await trigger(["highestScore", "bestBowling", "tournaments", "achievements"]);
                  if (ok) setStep(3);
                }}
                className="px-6 py-2 rounded-lg text-white transition bg-blue-600 hover:bg-blue-700"
              >
