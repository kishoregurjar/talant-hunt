...
//         animate={{ scale: 1, y: 0, opacity: 1 }}
//         transition={{ duration: 0.5, delay: 0.1 }}
//         className="bg-white md:rounded-2xl rounded-xl shadow-sm  w-full max-w-4xl border border-gray-200 mt-30 p-4 sm:p-10 transition duration-300 "
//       >
//         <motion.h1
//           initial={{ y: -20, opacity: 0 }}
//           animate={{ y: 0, opacity: 1 }}
//           transition={{ duration: 0.4, delay: 0.2 }}
//           className="text-3xl md:text-4xl font-bold mb-8 text-center text-[#4A4579] "
//         >
//           Player Registration Form
//         </motion.h1>
...
//                 type="text"
//                 placeholder="Virat Kohli"
//                 className="w-full pl-10 p-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-[#4A4579] outline-none"
//               />
//             </div>
//             {errors.name && (
//               <p className="text-red-500 text-sm">{errors.name.message}</p>
...
//                 <select
//                   {...register("dob.month")}
//                   className="w-full pl-3 p-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-2 focus:ring-[#4A4579] outline-none"
//                 >
//                   <option value="">Month</option>
//                   {[
//                     "January",
...
//                   required: "You must agree to the Terms & Conditions",
//                 })}
//                 className="mt-1 h-4 w-4 text-[#4A4579] border-gray-300 rounded focus:ring-[#4A4579]"
//               />
//               <label className="ml-2 text-sm text-gray-700">
//                 I have read and agree to the Terms & Conditions.
//               </label>
...
//               type="submit"
//               disabled={submitting}
//               className={`inline-flex items-center gap-2 px-6 py-3 bg-[#4A4579] text-white rounded-lg font-semibold shadow-md active:scale-95 transition-transform duration-200 ease-in-out
//                 ${submitting ? "opacity-60 cursor-not-allowed hover:bg-[#564989]" : "hover:bg-[#564989] hover:shadow-lg active:scale-95"}`}
//             >
//               {submitting ? (
//                 <span className="flex items-center justify-center">
//                   <span className="inline-block h-4 w-4 mr-2 rounded-full border-2 border-white border-t-transparent animate-spin"></span>
