...
//     /* ✅ Step 2 (was Step 3): Media & Verification */
...
//     // For batsman → batting style required
...
//     // For bowler → both batting + bowling required
//     if (role === "Bowler") {
...
//     // For wicket keeper → batting required, bowling ignored
//     if (role === "Wicket Keeper" && (!obj.battingStyle || obj.battingStyle.trim() === "")) {
//       ctx.addIssue({
//         path: ["battingStyle"],
//         code: "custom",
//         message: "Please select batting style",
